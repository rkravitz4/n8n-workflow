  ...
  const fetchRewards = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.error('Error fetching rewards:', errorData);
        alert(`Failed to load rewards: ${errorData.error || 'Unknown error'}`);
      }
    } catch (error) {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="text-3xl font-bold text-[#c27800] mt-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#c27800] text-white rounded-lg hover:bg-[#6b0000] transition-colors flex items-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {loading ? (
                      <tr>
                        <td colSpan={6} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center">
                            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#c27800] mb-4"></div>
                        ...
                        <td colSpan={6} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-[#c27800] text-white rounded-lg hover:bg-[#6b0000] transition-colors"
                            >
                              Create First Reward
                            </button>
                          </div>
                      ...
                      rewards.map((reward) => (
                        <tr key={reward.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-semibold text-[#c27800]">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button
                              ...
                              className="text-[#c27800] hover:text-[#6b0000] mr-4 font-medium"
                            >
                              Edit
                            </button>
                            <button
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {REWARD_TEMPLATES.map((template, index) => (
                        <button
                          ...
                          className="text-left p-4 border-2 border-gray-200 rounded-lg hover:border-[#c27800] hover:bg-[#c27800]/5 transition-all"
                        >
                          <div className="font-medium text-gray-900">{template.name}</div>
                          <div className="text-sm text-gray-600 mt-1">{template.description}</div>
                          <div className="flex items-center justify-between mt-3">
                            <span className="text-xs text-gray-500">{template.points_cost} points</span>
                            <span className="text-sm font-semibold text-[#c27800]">
                    ...
                    <div className="mt-6 text-center">
                      <button
                        ...
                        className="text-[#c27800] hover:text-[#6b0000] text-sm font-medium"
                      >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c27800] focus:border-transparent text-gray-900 placeholder-gray-500"
                              />
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                required
                                rows={3}
                                placeholder="e.g., Save $10 on any order at Matt the Miller's"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c27800] focus:border-transparent text-gray-900 placeholder-gray-500"
                              />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <select
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c27800] focus:border-transparent text-gray-900"
                              >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                              ...
                              <button
                                ...
                                className="px-4 py-2 bg-[#c27800] text-white rounded-lg hover:bg-[#6b0000] transition-colors text-sm"
                              >
                        ...
                        <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                          ...
                          <button
                            type="submit"
                            disabled={saving}
                            className="px-6 py-2 bg-[#c27800] text-white rounded-lg hover:bg-[#6b0000] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center font-medium"
                          >
                            {saving ? (
                              <>
                    ...
                    {showPreview && (
                      <div className="lg:col-span-1">
                        <div className="sticky top-24 bg-gray-50 rounded-lg p-4 border-2 border-[#c27800]/20">
                          ...
                          <div className="bg-white rounded-2xl shadow-xl p-4 border border-gray-200">
                            ...
                            <div className="text-center">
                              <div className="text-2xl font-bold text-[#c27800] mb-1">
                              ...
                              <button 
                                type="button"
                                className="w-full py-2 px-4 bg-[#c27800] text-white text-sm font-semibold rounded-lg opacity-50 cursor-not-allowed"
                              >
                                Redeem
                              </button>
                            </div>
